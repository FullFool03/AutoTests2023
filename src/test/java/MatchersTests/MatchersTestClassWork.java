...
public class MatchersTestClassWork {
...
//        MatcherAssert.assertThat(page.getWrongLoginFiled().innerText(), equalTo(str));
...
//        MatcherAssert.assertThat(page.getQrText().innerText(), equalTo(str));
//    }
}
